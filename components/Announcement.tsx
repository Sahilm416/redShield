...
export default async function Ammouncement() {
  ...
  return (
    <div className="h-[7vw] w-full flex justify-center items-center absolute mt-[20px] right-0 transition-all fade-in-100">
      ...
      >
        <div className=" h-[40px] px-2 rounded-3xl bg-zinc-50 dark:bg-[#111111] border-zinc-200 dark:border-zinc-800 flex justify-center items-center gap-2 border transition-shadow fade-in-[400] hover:shadow-md">
