...
export default function SubHero() {
  return (
    <motion.div initial={{opacity: 0 , dur:1 }} whileInView={{opacity: 1 }} className=" w-full h-max flex flex-col items-center">
      ...
      <div className="flex w-full justify-center max-w-[1500px] px-[7vw] bg-white dark:bg-gray-900/20">
        <div className="h-full w-full border border-dashed border-[#EBEBEB] dark:border-[#1F1F1F] grid md:grid-cols-2 grid-cols-1">
